...
const PLACEHOLDER_TESTIMONIALS: Testimonial[] = [
  {
    id: 1,
    quote:
      "Desi has completely transformed how I wear perfume. The complexity of the notes is unmatched.",
    rating: 5,
    name: "Sarah Jenkins",
...
export default function TestimonialsSection({
  ...
  return (
    <section className="w-full py-20 px-6 md:px-12 relative z-10 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative">
        ...
        <div className="flex flex-col items-center justify-center mb-16 relative z-10">
          <h2 className="font-serif text-3xl md:text-4xl text-slate-900 text-center tracking-tight mb-4">
            Loved by Creatives
          </h2>
